...
module TcHmi {
    export module Controls {
        export module ContextMenu {
            export class ContextMenuControl extends TcHmi.Controls.System.TcHmiControl {
                ...
                */
                ...
                public __elementList!: JQuery;
                protected __documentClickHandler = this.__onClick();
                protected __optionSelect = this.__optionSelectHandler();
                ...
                */
                ...
                public __optionSelectHandler() {

                    var _this = this;
                    return function (event : any) {
                        if (event.srcElement.tagName === "A") {
                            let _action = event.srcElement.getAttribute("data-action");
                            let _caller : string = event.srcElement.getAttribute("data-caller");
                            let option : Option = { action: _action, text: event.srcElement.text }

                            let _callerRef = TcHmi.Controls.get(_caller) as any;
        ...
        registerEx('ContextMenuControl', 'TcHmi.Controls.ContextMenu', ContextMenu.ContextMenuControl);
    }
}